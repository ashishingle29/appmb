...
import { BookDashed, LayoutDashboard, LogIn } from "lucide-react";
  ...
  return (
    <header className="w-full p-4  px-5 sm:px-10 flex items-center justify-between">
        ...
        <div className=" hidden sm:flex items-center gap-1">
            {/* <a href={route.login} className="inline-block w-6 h-6 mr-4" aria-label="login"><LogIn/></a>
            <a href={route.admin} className="inline-block w-6 h-6 mr-4" aria-label="login"><LayoutDashboard/></a> */}
            {/* <a href={route.register} className="inline-block w-6 h-6 mr-4" aria-label="login">Register</a>
